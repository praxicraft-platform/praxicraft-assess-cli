...
func Register(parent *cobra.Command, rt *runtime.Runtime) {
	...
	bulk := &cobra.Command{Use: "bulk-create", RunE: func(c *cobra.Command, args []string) error {
	...
	analytics := &cobra.Command{Use: "analytics", RunE: func(c *cobra.Command, args []string) error {
		return cmdutil.Run(rt, func() (any, error) { return rt.API.InterviewsAnalytics(rt.Context(), cmdutil.QueryFromPairs(aq)) })
	}}
	analytics.Flags().StringArrayVar(&aq, "query", nil, "query key=value")
	cmd.AddCommand(analytics)

	orgCases := &cobra.Command{Use: "org-cases", RunE: func(c *cobra.Command, args []string) error {
		return cmdutil.Run(rt, func() (any, error) { return rt.API.InterviewsOrgCases(rt.Context(), cmdutil.QueryFromPairs(oq)) })
	}}
	orgCases.Flags().StringArrayVar(&oq, "query", nil, "query key=value")
	cmd.AddCommand(orgCases)

	cmd.AddCommand(&cobra.Command{Use: "get [room-id]", Args: cobra.ExactArgs(1), RunE: func(c *cobra.Command, args []string) error {
		return cmdutil.Run(rt, func() (any, error) { return rt.API.InterviewsGet(rt.Context(), args[0]) })
	}})
	var cancelBody, cancelFile string
	cancel := &cobra.Command{Use: "cancel [room-id]", Args: cobra.ExactArgs(1), RunE: func(c *cobra.Command, args []string) error {
		if err := cmdutil.ConfirmDestructive(rt, "Cancel this interview?"); err != nil { return err }
	...
	reschedule := &cobra.Command{Use: "reschedule [room-id]", Args: cobra.ExactArgs(1), RunE: func(c *cobra.Command, args []string) error {
	...
	cmd.AddCommand(&cobra.Command{Use: "analysis [room-id]", Args: cobra.ExactArgs(1), RunE: func(c *cobra.Command, args []string) error {
		return cmdutil.Run(rt, func() (any, error) { return rt.API.InterviewsAnalysis(rt.Context(), args[0]) })
	}})
	cmd.AddCommand(&cobra.Command{Use: "replay [room-id]", Args: cobra.ExactArgs(1), RunE: func(c *cobra.Command, args []string) error {
		return cmdutil.Run(rt, func() (any, error) { return rt.API.InterviewsReplay(rt.Context(), args[0]) })
	}})
	var sbody, sfile string
	share := &cobra.Command{Use: "share [room-id]", Args: cobra.ExactArgs(1), RunE: func(c *cobra.Command, args []string) error {
	...
	templates.AddCommand(&cobra.Command{Use: "list", RunE: func(c *cobra.Command, args []string) error {
		return cmdutil.Run(rt, func() (any, error) { return rt.API.InterviewTemplatesList(rt.Context()) })
	}})
	var tbody, tfile string
	tcreate := &cobra.Command{Use: "create", RunE: func(c *cobra.Command, args []string) error {
	...
	templates.AddCommand(&cobra.Command{Use: "get [id]", Args: cobra.ExactArgs(1), RunE: func(c *cobra.Command, args []string) error {
		return cmdutil.Run(rt, func() (any, error) { return rt.API.InterviewTemplatesGet(rt.Context(), args[0]) })
	}})
	var tubody, tufile string
	tupdate := &cobra.Command{Use: "update [id]", Args: cobra.ExactArgs(1), RunE: func(c *cobra.Command, args []string) error {
	...
	templates.AddCommand(&cobra.Command{Use: "delete [id]", Args: cobra.ExactArgs(1), RunE: func(c *cobra.Command, args []string) error {
		if err := cmdutil.ConfirmDestructive(rt, "Delete this template?"); err != nil { return err }
